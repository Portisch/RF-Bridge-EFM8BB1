...
/*
 * SonOff PI PT2260 protocol, Issue #115
 */
#if EFM8BB1_SUPPORT_SonOff_PIR_PROTOCOL == 1
#define SonOff_PIR
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(SonOff_PIR)[], static uint16_t, SI_SEG_CODE) = { 400, 1200, 12500 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(SonOff_PIR)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(2) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(SonOff_PIR)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(SonOff_PIR)[], static uint8_t, SI_SEG_CODE) = { HIGH(1), LOW(0) };
#endif
...
#if EFM8BB1_SUPPORT_SonOff_PIR_PROTOCOL == 1
		/*
		 * SonOff PI PT2260 protocol
		 */
		{
			{ &PROTOCOL_BUCKETS(SonOff_PIR), ARRAY_LENGTH(PROTOCOL_BUCKETS(SonOff_PIR)) },
			{ &PROTOCOL_START(SonOff_PIR), ARRAY_LENGTH(PROTOCOL_START(SonOff_PIR)) },
			{ &PROTOCOL_BIT0(SonOff_PIR), ARRAY_LENGTH(PROTOCOL_BIT0(SonOff_PIR)) },
			{ &PROTOCOL_BIT1(SonOff_PIR), ARRAY_LENGTH(PROTOCOL_BIT1(SonOff_PIR)) },
			{ NULL, 0 },
			24
		},
#endif
