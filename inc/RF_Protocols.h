 ...
 * PT2262, Issue #116
 */
#if EFM8BB1_SUPPORT_PT2262_PROTOCOL == 1
#define PT2262
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(PT2262)[], static uint16_t, SI_SEG_CODE) = { 210, 920, 8130 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(PT2262)[], static uint8_t, SI_SEG_CODE) = { LOW(0), HIGH(2) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(PT2262)[], static uint8_t, SI_SEG_CODE) = { LOW(0), HIGH(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(PT2262)[], static uint8_t, SI_SEG_CODE) = { LOW(1), HIGH(0) };
#endif
...
SI_SEGMENT_VARIABLE(PROTOCOL_DATA[], static struct BUCKET_PROTOCOL_DATA, SI_SEG_CODE) =
{
		 ...
		 */
		{
			{ &PROTOCOL_BUCKETS(PT2262), ARRAY_LENGTH(PROTOCOL_BUCKETS(PT2262)) },
			{ &PROTOCOL_START(PT2262), ARRAY_LENGTH(PROTOCOL_START(PT2262)) },
			{ &PROTOCOL_BIT0(PT2262), ARRAY_LENGTH(PROTOCOL_BIT0(PT2262)) },
			{ &PROTOCOL_BIT1(PT2262), ARRAY_LENGTH(PROTOCOL_BIT1(PT2262)) },
			{ NULL, 0 },
			24
		},
#endif
